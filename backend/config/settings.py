...
EMAIL_BACKEND = os.getenv(
    ...
    "django.core.mail.backends.console.EmailBackend"  # Console for dev, use SMTP in prod
)
...
DEFAULT_FROM_EMAIL = os.getenv("DJANGO_DEFAULT_FROM_EMAIL", "noreply@checkmate-driving.com")
